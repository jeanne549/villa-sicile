  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
      ...
      <div ref={parallaxRef} className="absolute inset-0 scale-110">
        <Image
          src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=1920&q=85&fit=crop"
          alt="Villa de luxe en Sicile face à la Méditerranée"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20">
        <div className="max-w-3xl">
          <p className="font-display text-gold-light text-xs tracking-[0.5em] uppercase mb-6 animate-fade-in">
          ...
          <p className="font-sans text-white/80 text-lg md:text-xl leading-relaxed max-w-xl mb-10">
            Une demeure d&apos;exception nichée sur les hauteurs de la côte sicilienne.
            Vue panoramique sur la Méditerranée, piscine à débordement, luxe absolu.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#contact" className="btn-gold">
              Vérifier les disponibilités
            </a>
            <a href="#villa" className="btn-outline border-white/70 text-white hover:bg-white hover:text-navy">
              Découvrir la villa
            </a>
          </div>
        </div>
