...
export default function Confidentialite() {
  return (
    <LegalLayout title="Politique de confidentialité" jsonLd={getBreadcrumbSchema([{ name: 'Villa Vénus Noto', item: 'https://www.villavenusnoto.com/fr' }, { name: 'Politique de confidentialité', item: 'https://www.villavenusnoto.com/confidentialite' }])}>
      ...
      <p className="mt-3">
        Pour exercer ces droits : <a href="mailto:contact@villavenusnoto.com" className="text-gold hover:underline">contact@villavenusnoto.com</a>.
      ...
      <p>
        ...
        Pour en savoir plus, consultez notre <a href="/cookies" className="text-gold hover:underline">politique cookies</a>.
      </p>
